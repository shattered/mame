...
static INPUT_PORTS_START( ie15_keyboard )
	PORT_START("IE15_CFG")
	PORT_CONFNAME( 0x01, 0x00, "Keypad" )
	PORT_CONFSETTING(    0x00, "Cursor" )
	PORT_CONFSETTING(    0x01, "Numeric" )
	...
	PORT_BIT(0x002000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 7") PORT_CODE(KEYCODE_7_PAD)
	PORT_BIT(0x004000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 8") PORT_CODE(KEYCODE_8_PAD)
	PORT_BIT(0x008000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 9") PORT_CODE(KEYCODE_9_PAD)
	...
	PORT_BIT(0x200000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f1 (newline)") PORT_CODE(KEYCODE_7_PAD)
	PORT_BIT(0x400000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f2 (up)") PORT_CODE(KEYCODE_8_PAD)
	PORT_BIT(0x800000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f3 (home)") PORT_CODE(KEYCODE_9_PAD)
	...
	PORT_BIT(0x001000, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x002000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 4") PORT_CODE(KEYCODE_4_PAD)
	PORT_BIT(0x004000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 5") PORT_CODE(KEYCODE_5_PAD)
	PORT_BIT(0x008000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 6") PORT_CODE(KEYCODE_6_PAD)
	...
	PORT_BIT(0x200000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f4 (left)")  PORT_CODE(KEYCODE_4_PAD)
	PORT_BIT(0x400000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f5 (origin)") PORT_CODE(KEYCODE_5_PAD)
	PORT_BIT(0x800000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f6 (right)") PORT_CODE(KEYCODE_6_PAD)
	...
	PORT_BIT(0x002000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 1") PORT_CODE(KEYCODE_1_PAD)
	PORT_BIT(0x004000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 2") PORT_CODE(KEYCODE_2_PAD)
	PORT_BIT(0x008000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 3") PORT_CODE(KEYCODE_3_PAD)
	...
	PORT_BIT(0x200000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f7 (delete)") PORT_CODE(KEYCODE_1_PAD)
	PORT_BIT(0x400000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f8 (down)") PORT_CODE(KEYCODE_2_PAD)
	PORT_BIT(0x800000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("f9 (insert)") PORT_CODE(KEYCODE_3_PAD)
	...
	PORT_BIT(0x000800, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_EQUALS) PORT_CHAR('_') // XXX
	PORT_BIT(0x001000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_SPACE) PORT_CHAR(' ')
	PORT_BIT(0x002000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad 0") PORT_CODE(KEYCODE_0_PAD)
	PORT_BIT(0x004000, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x008000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x01) PORT_NAME("Keypad ,") PORT_CODE(KEYCODE_DEL_PAD) PORT_CHAR(UCHAR_MAMEKEY(DEL_PAD))
	...
	PORT_BIT(0x200000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("fA (scroll down)") PORT_CODE(KEYCODE_DEL) PORT_CHAR(UCHAR_MAMEKEY(DEL))
	PORT_BIT(0x400000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("fB (set mark)") PORT_CODE(KEYCODE_END) PORT_CHAR(UCHAR_MAMEKEY(END))
	PORT_BIT(0x800000, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CONDITION("IE15_CFG", 0x01, EQUALS, 0x00) PORT_NAME("fC (scroll up)") PORT_CODE(KEYCODE_PGDN) PORT_CHAR(UCHAR_MAMEKEY(PGDN))
