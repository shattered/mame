...
ie15_terminal_device::ie15_terminal_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock)
	: ie15_device(mconfig, IE15_TERMINAL, "IE15 Terminal", tag, owner, clock, "ie15_terminal", __FILE__)
...
const device_type IE15_TERMINAL = &device_creator<ie15_terminal_device>;
