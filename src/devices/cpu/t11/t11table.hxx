...
const t11_device::opcode_func t11_device::s_opcode_table[65536 >> 3] =
{
	...
	/* 0x7000 */
	OP(mul_rg),     OP(mul_rgd),    OP(mul_in),     OP(mul_ind),    OP(mul_de),     OP(mul_ded),    OP(mul_ix),     OP(mul_ixd),
	OP(mul_rg),     OP(mul_rgd),    OP(mul_in),     OP(mul_ind),    OP(mul_de),     OP(mul_ded),    OP(mul_ix),     OP(mul_ixd),
	OP(mul_rg),     OP(mul_rgd),    OP(mul_in),     OP(mul_ind),    OP(mul_de),     OP(mul_ded),    OP(mul_ix),     OP(mul_ixd),
	OP(mul_rg),     OP(mul_rgd),    OP(mul_in),     OP(mul_ind),    OP(mul_de),     OP(mul_ded),    OP(mul_ix),     OP(mul_ixd),
	/* 0x7100 */
	...
	OP(mul_rg),     OP(mul_rgd),    OP(mul_in),     OP(mul_ind),    OP(mul_de),     OP(mul_ded),    OP(mul_ix),     OP(mul_ixd),
	/* 0x7200 */
	OP(div_rg),     OP(div_rgd),    OP(div_in),     OP(div_ind),    OP(div_de),     OP(div_ded),    OP(div_ix),     OP(div_ixd),
	OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),
	OP(div_rg),     OP(div_rgd),    OP(div_in),     OP(div_ind),    OP(div_de),     OP(div_ded),    OP(div_ix),     OP(div_ixd),
	OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),
	/* 0x7300 */
	...
	OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),    OP(illegal),
	/* 0x7400 */
	OP(ash_rg),     OP(ash_rgd),    OP(ash_in),     OP(ash_ind),    OP(ash_de),     OP(ash_ded),    OP(ash_ix),     OP(ash_ixd),
	OP(ash_rg),     OP(ash_rgd),    OP(ash_in),     OP(ash_ind),    OP(ash_de),     OP(ash_ded),    OP(ash_ix),     OP(ash_ixd),
	OP(ash_rg),     OP(ash_rgd),    OP(ash_in),     OP(ash_ind),    OP(ash_de),     OP(ash_ded),    OP(ash_ix),     OP(ash_ixd),
	OP(ash_rg),     OP(ash_rgd),    OP(ash_in),     OP(ash_ind),    OP(ash_de),     OP(ash_ded),    OP(ash_ix),     OP(ash_ixd),
	/* 0x7500 */
	...
	OP(ash_rg),     OP(ash_rgd),    OP(ash_in),     OP(ash_ind),    OP(ash_de),     OP(ash_ded),    OP(ash_ix),     OP(ash_ixd),
	/* 0x7600 */
	OP(ashc_rg),    OP(ashc_rgd),   OP(ashc_in),    OP(ashc_ind),   OP(ashc_de),    OP(ashc_ded),   OP(ashc_ix),    OP(ashc_ixd),
	OP(ashc_rg),    OP(ashc_rgd),   OP(ashc_in),    OP(ashc_ind),   OP(ashc_de),    OP(ashc_ded),   OP(ashc_ix),    OP(ashc_ixd),
	OP(ashc_rg),    OP(ashc_rgd),   OP(ashc_in),    OP(ashc_ind),   OP(ashc_de),    OP(ashc_ded),   OP(ashc_ix),    OP(ashc_ixd),
	OP(ashc_rg),    OP(ashc_rgd),   OP(ashc_in),    OP(ashc_ind),   OP(ashc_de),    OP(ashc_ded),   OP(ashc_ix),    OP(ashc_ixd),
	/* 0x7700 */
